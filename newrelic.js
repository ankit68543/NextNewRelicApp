 ...
 */
console.log("==================NEXT_PUBLIC_NEW_RELIC_APP_NAME=================================================",process.env.NEXT_PUBLIC_NEW_RELIC_APP_NAME)
console.log("==================NEXT_PUBLIC_NEW_RELIC_APP_NAME=================================================",process.env.NEXT_PUBLIC_NEW_RELIC_LICENSE_KEY)
exports.config = {
  app_name: [process.env.NEXT_PUBLIC_NEW_RELIC_APP_NAME],
